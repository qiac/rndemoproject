...
import com.hyphenate.easeui.adapter.GKStoreImageAdapter;
...
public class EaseChatMessageList extends RelativeLayout{
    ...
    private void init(Context context){
        ...
        // 添加Header
        View view = LayoutInflater.from(context).inflate(R.layout.gk_imchat_header, null);
        HorizontalListView hrlListView = (HorizontalListView) view.findViewById(R.id.hlv_list_view);

        String[] listDatas = new String[] {"Red", "Dark Gray", "Green","Red", "Dark Gray", "Green","Red", "Dark Gray", "Green"};
        GKStoreImageAdapter adapter = new GKStoreImageAdapter(context, listDatas);
        hrlListView.setAdapter(adapter);
     ...
     * @param avatar
     */
    public void setRecruiterAvatar(String avatar) {
        messageAdapter.setRecruiterAvatar(avatar);
    }
     ...
     * @param avatar
     */
    public void setCandidateAvatar(String avatar) {
        messageAdapter.setCandidateAvatar(avatar);
    }
}
