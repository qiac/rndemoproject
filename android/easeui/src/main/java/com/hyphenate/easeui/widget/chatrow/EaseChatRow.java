...
public abstract class EaseChatRow extends LinearLayout {
    ...
    protected RoundedImageView userAvatarView;
    ...
    private void initView() {
        ...
        userAvatarView = (RoundedImageView) findViewById(R.id.iv_userhead);
    ...
    private void setUpBaseView() {
        ...
        // 设置头像和nick
        int defaultAvatarResId = 0;
        if(message.direct() == Direct.SEND) {
            // 店长端头像为椭圆
            userAvatarView.setCornerRadiusDimen(R.dimen.chatto_avatar_corner);
            // 默认头像
            defaultAvatarResId = R.drawable.gk_default_recruiter_avatar;
            // 头像地址
            String avatar = ((EaseMessageAdapter) adapter).getRecruiterAvatar();

            EaseUserUtils.setUserAvatar(context, userAvatarView, avatar, defaultAvatarResId);
        } else {
            // 应聘者端头像为圆形
            userAvatarView.setCornerRadiusDimen(R.dimen.chatfrom_avatar_corner);
            // 默认头像
            defaultAvatarResId = R.drawable.gk_default_candidate_avatar;
            // 头像地址
            String avatar = ((EaseMessageAdapter) adapter).getCandidateAvatar();
