...
import com.gikoo5.hyphenate.widget.ChatRowVoiceCall;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentListener{
    ...
    protected void setUpView() {
        ...
        if (chatType == Constant.CHATTYPE_SINGLE) { 
            Map<String,RobotUser> robotMap = EMHelper.getInstance().getRobotList();
        ...
        // 设置店长头像
        String recruiterAvatar = GKPreferenceManager.getString(GKConstant.RECRUITER_AVATAR, null);
        messageList.setRecruiterAvatar(recruiterAvatar);
        ...
        if(conversation != null) {
            ...
            if(message != null) {
                if(message.direct() == EMMessage.Direct.SEND) {
                    candidateAvatar = message.getStringAttribute(Constant.EXTEND_ATTR_TO_AVATAR, null);
                } else {
                    candidateAvatar = message.getStringAttribute(Constant.EXTEND_ATTR_FROM_AVATAR, null);
                }
            }
        }
        messageList.setCandidateAvatar(candidateAvatar);
    }
