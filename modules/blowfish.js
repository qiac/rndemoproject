...
function pkcs7_encode(text, block_size) {
...
function pkcs7_decode(text) {
	return text(0, text.length-text.charCodeAt(text.length-1));
}

function encrypt_with_pkcs7_bf(key, text) {
	var bf = new Blowfish(key);
	return bf.encrypt(pkcs7_encode(text, 8));
}

module.exports = encrypt_with_pkcs7_bf;
